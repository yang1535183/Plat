/*! v1.2.3 | pageoffice.js | (c) 2016, 2018 Beijing zhuozheng zhiyuan software, Inc.*/
...
var POBrowser = {
	...
	openWindow : function(strURL, strOptions, strArgument) {
		...
		jQuery.post(this.getRootPath() + "/poserver.zz", {
			...
			if (!bPOBrowserOpened) {
				...
				if (POBrowser.isOldIE()
						&& (parseInt(POBrowser.getBrowserVer(), 10) >= 8)
	...
	openWindowModeless : function(strURL, strOptions, strArgument) {
		...
		if (strOptions[strOptions.length - 1] != ';')
		...
		jQuery.post(this.getRootPath() + "/poserver.zz", {
			...
			if (POBrowser.isOldIE()
				...
				if (xdr) {
					...
					xdr.open("POST", PO_code + "checkopened.htm?x="
							+ po_uuid(8, 16));
	...
	resumePO : function() {
		jQuery.getJSON(PO_code + "resume.htm?parent=" + POParent
...
jQuery(function() {
	jQuery("body")
			.append(
					"<div class=\"pobmodal-overlay\"><div id=\"pobmodal-dialog\"><h2>提示</h2>当前文档正处于打开状态，请点击<a style='color:red;' href=\"javascript:POBrowser.resumePO();\" > 这里 </a>切换PageOffice窗口继续查看或编辑文档。<div class=\"button-holder\"></br></br><a class=\"button blue\" href=\"javascript:POBrowser.resumePO();\" > 立即切换 PageOffice 窗口</a></div></div></div>");
