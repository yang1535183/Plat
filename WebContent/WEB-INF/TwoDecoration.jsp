...
<body>
		...
		<form id="tableForm" action="twoDecoration.do" method="post">
			<table border="1" bordercolor="black"
				...
				<tr>
					...
					<td>工程名称</td>
					<td colspan="2"><input id="工程名称" name="engname" type="text"
						value="${requestScope.td.engname }" /></td>
					<td>工程地点</td>
					<td colspan="2"><input id="区" name="engpositionqu" type="text"
	...
	<!--endprint1-->
	<c:if test="${requestScope.td==null }">
		<div>
